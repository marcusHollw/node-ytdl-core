...
exports.getBasicInfo = async(id, options) => {
  if (typeof options.IPv6Block === "object" && options.IPv6Block.length === 1) {
    options.requestOptions = Object.assign({}, options.requestOptions, {
      family: 6,
      localAddress: options.IPv6Block.length >= 2 ? options.IPv6Block[Math.floor(Math.random() * options.IPv6Block.length)] : options.IPv6Block[0]
    });
  }
